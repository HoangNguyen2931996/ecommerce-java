            ...
            <section id="category-grid">
                <div class="container">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin sidebar narrow">
                            ...
                            <div class="body bordered">
                                ...
                                <div class="price-filter">
                                    ...
                                    <div class="price-range-holder">
                                        ...
                                        <span class="min-max">
                                        Price: 1,000,000 - 50,000,000VNĐ
                                        </span>
                                        <span class="filter-button">
                                        <a href="javascript:void(0)" onclick="return searchPrice(${objCat.id_cat})">Filter</a>
                                        </span>
                                    </div>
                                </div>
                                <!-- /.price-filter -->
                        ...
                        function searchPrice(Id_cat){
                    	 	var x = $('.price-slider').val();
                    	 	if(x ===""){
                    	 		return false;
                    	 	}
    	 	 				$.ajax({
    							url: '${pageContext.request.contextPath }/searchPrice',
    							type: 'POST',
    							cache: false,
    							data: {
    								price: x,
                                                ...
                                                <div class="col-xs-12 col-sm-6 text-left">
                                                    <ul class="pagination ">
														...
														<c:if test="${currentPage>1 && sumPage > 0 }">
															<li><a href="${pageContext.request.contextPath }/${slugUtils.makeSlug(objCat.name_cat)}-${objCat.id_cat}?page=${currentPage - 1 }">previous</a></li>
														</c:if>
														...
														<c:forEach var="i" begin="${pageStart }" end="${pageEnd }" step="1">
															<li <c:if test="${currentPage==i }">class="current"</c:if> ><a href="${pageContext.request.contextPath }/${slugUtils.makeSlug(objCat.name_cat)}-${objCat.id_cat}?page=${i }">${i }</a></li>
														</c:forEach>
														<c:if test="${currentPage < sumPage && sumPage > 1 }">
															<li><a href="${pageContext.request.contextPath }/${slugUtils.makeSlug(objCat.name_cat)}-${objCat.id_cat}?page=${currentPage + 1 }">Next</a></li> 
														</c:if>
                                                    </ul>
                                                </div>
