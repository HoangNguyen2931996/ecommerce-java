			...
			<div class="panel panel-default card-view">
				<div class="panel-wrapper collapse in">
					<div class="panel-body">
						<div class="form-wrap">
							<form id="edit_user" action="${pageContext.request.contextPath }/sua/${objUser.id_user}" method="post" enctype="multipart/form-data">
							<c:if test="${not empty msg }">
								...
								<div class="form-actions">
									...
									<a href="${pageContext.request.contextPath }/" type="button" class="btn btn-warning pull-left">Go back</a>
