			...
			<div class="panel panel-default card-view">
				<div class="panel-wrapper collapse in">
					<div class="panel-body">
						<div class="form-wrap">
							<form id="add_cat" action="${pageContext.request.contextPath }/admin/payment/add" method="post">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input name="name_payment" type="text" id="firstName" class="form-control" placeholder="Tên phương thức">
