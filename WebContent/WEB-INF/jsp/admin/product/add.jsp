...
<div class="container-fluid">
	...
	<div class="row heading-bg">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
		  <h5 class="txt-dark">Thêm sản phẩm</h5>
		</div>
		<!-- /Breadcrumb -->
	</div>
	<!-- /Title -->
			...
			<div class="panel panel-default card-view">
				<div class="panel-wrapper collapse in">
					<div class="panel-body">
						<div class="form-wrap">
							<form id="add_product" action="${pageContext.request.contextPath }/admin/product/add" method="post" enctype="multipart/form-data">
							<c:if test="${not empty msg }">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input name="name_product" type="text" id="firstName" class="form-control" placeholder="tên sản phẩm">
											...
											<div class="radio-list">
												<div class="radio-inline pl-0">
													<div class="radio radio-info">
														<input type="radio" name="status_product" id="radio1" value="1" >
														<label for="radio1">Công bố</label>
													</div>
												</div>
												<div class="radio-inline">
													<div class="radio radio-info">
														<input type="radio" name="status_product" id="radio2" value="0" checked>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div class="radio-list">
												<div class="radio-inline pl-0">
													<div class="radio radio-info">
														<input type="radio" name="highlight" id="radio1" value="1" >
														<label for="radio1">Có</label>
													</div>
												</div>
												<div class="radio-inline">
													<div class="radio radio-info">
														<input type="radio" name="highlight" id="radio2" value="0" checked>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input name="price_product" type="text" class="form-control" id="exampleInputuname" placeholder="">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<textarea name="preview_product" class="form-control" rows="4"></textarea>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<textarea id="detail_ecommerce" name="detail_product" class="form-control" rows="4"></textarea>
										</div>
									</div>
								</div>
								<script type="text/javascript">
