						...
						<div class="form-wrap">
							...
							<c:if test="${not empty msg }">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<img class="form-control" style="width: 170px; height: 100px" alt="" src="${pageContext.request.contextPath }/files/${objSlide.pic_slide}">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<c:forEach items="${alProduct }" var="objProduct">
												<option <c:if test="${objProduct.id_product == objSlide.id_product }">selected="selected"</c:if> value="${objProduct.id_product }">${objProduct.name_product }</option>
											</c:forEach>
											</select>
										</div>
									</div>	
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<textarea name="des_slide" class="form-control" rows="4">${objSlide.des_slide }</textarea>
										</div>
									</div>
								</div>
