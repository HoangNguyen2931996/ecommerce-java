	...
	$(document).ready(function (){
		$('#add_user').validate({
			...
			messages:{
				...
				password:{
					required: "<p class='vali-error'>Vui lòng nhập mật khẩu</p>",
					minlength: "<p class='vali-error'>Vui lòng nhập ít nhất 4 ký tự</p>",
					maxlength: "<p class='vali-error'>Vui lòng nhập nhiều nhất 15 ký tự</p>"
				},
				re_password:{
			...
			<div class="panel panel-default card-view">
				<div class="panel-wrapper collapse in">
					<div class="panel-body">
						<div class="form-wrap">
							<form id="add_user" action="${pageContext.request.contextPath }/admin/user/add" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<br />
											<label class="control-label mb-10 " style="color: red">${msg }</label>
											</c:if>
